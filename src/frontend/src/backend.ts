...
export class Backend implements backendInterface {
    ...
    async getLeaderboard(): Promise<Array<ScoreData>> {
    ...
    async getScore(): Promise<ScoreData> {
        if (this.processError) {
            try {
                const result = await this.actor.getScore();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async recordInteraction(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.recordInteraction(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
